...
short_description = "Test MDAKit Project with dependencies using condaforge and no ReadTheDocs".strip().split("\n")[0]
...
setup(
    ...
    # url='mdakit-cookie.readthedocs.io/en/latest/',  # Website
    # platforms=['Linux',
    #            'Mac OS-X',
    #            'Unix',
