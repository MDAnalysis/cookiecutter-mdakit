...
The {{cookiecutter.project_name}} *Code of Conduct* sets the rules for the behavior of
every member in the {{cookiecutter.project_name}} community so that everyone can
...
{{cookiecutter.project_name}} is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make {{cookiecutter.project_name}} a welcoming and productive community.
...
modified by {{cookiecutter.project_name}}.
