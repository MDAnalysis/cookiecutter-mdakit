"""
{{ cookiecutter.template_analysis_class }} --- :mod:`{{ cookiecutter.package_name }}.analysis.{{ cookiecutter.template_analysis_class }}`
===========================================================

This module contains the :class:`{{ cookiecutter.template_analysis_class }}` class.
