"""
MyAnalysisClass --- :mod:`mdakit_cookie.analysis.MyAnalysisClass`
===========================================================

This module contains the :class:`MyAnalysisClass` class.
...
class MyAnalysisClass(AnalysisBase):
    """MyAnalysisClass class.
