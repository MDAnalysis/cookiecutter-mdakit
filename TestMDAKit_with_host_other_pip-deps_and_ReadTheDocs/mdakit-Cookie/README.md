TestMDAKit_with_host_other_pip-deps_and_ReadTheDocs
==============================
[//]: # (Badges)
...
To build TestMDAKit_with_host_other_pip-deps_and_ReadTheDocs from source,
...
Please cite [MDAnalysis](https://github.com/MDAnalysis/mdanalysis#citation) when using TestMDAKit_with_host_other_pip-deps_and_ReadTheDocs in published work.
